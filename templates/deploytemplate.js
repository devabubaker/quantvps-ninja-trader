...
export function deployTemplate(
  ...
  const emailBody = `
        ...
        Your QuantVPS virtual server has successfully been provisioned.

        You can access your server using the credentials found in the QuantVPS user dashboard.
        ...
        Subscription id: ${transactionNumber}
        Status: Paid
